...
// Defaults: claude-haiku-4-5-20251001 for chat, claude-sonnet-5 for composition.
...
export const LLM_MODELS = {
  ...
  composition: env?.VITE_MODEL_COMPOSE ?? processEnv?.VITE_MODEL_COMPOSE ?? "claude-sonnet-5",
} as const;
