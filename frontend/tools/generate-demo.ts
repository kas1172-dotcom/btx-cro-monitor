...
const cachedFlows = [
  {
    ...
    activatedTabs: ["programs", "capacity", "analysis", "accounts"],
  ...
  },
  {
    ...
    activatedTabs: ["map", "accounts", "programs", "capacity", "analysis"],
  ...
  },
  {
    ...
    intent: "account_risk",
    activatedTabs: ["analysis", "accounts", "settings"],
    deliverableType: null,
  ...
  },
  {
    ...
    intent: "capabilities",
    activatedTabs: ["capacity", "analysis", "programs"],
    deliverableType: null,
  ...
  },
  {
    ...
    intent: "weekly_brief",
    activatedTabs: ["brief", "programs", "analysis", "accounts", "capacity"],
