...
def _system_prompt() -> str:
    return (
        ...
        "- Do not claim a source works, covers a topic, or has a stable response "
        "shape until fetch_sample/probe_source evidence supports it.\n"
        "- If a brief cannot be resolved, say what was tried and what evidence was "
        "missing instead of fabricating a source.\n"
